...
class FeedAcceptanceTests: XCTestCase {
    ...
    private func showCommentsForFirstImage() -> ListViewController {
        ...
        return navigationController?.topViewController as! ListViewController // navigationController?.viewControllers[0]
    }
    ...
    private func makeImageData() -> Data {
        return UIImage.make(withColor: .red).pngData(withAlpha: false)!
    }
